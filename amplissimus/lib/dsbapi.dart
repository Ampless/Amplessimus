...
class DsbAccount {
  ...
  Future<String> getData() async {
    ...
    jsonResponse.forEach((k, v) { print(k); print(v); });
    assert(jsonResponse[0] is Map);
    assert(jsonResponse[0].containsKey('d'));
    return utf8.decode(gzip.decode(base64.decode(jsonResponse[0]['d'])));
  }
}
