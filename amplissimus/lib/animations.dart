...
class Animations {
  static void changeScreenNoAnimation(Object object, BuildContext context) {
    ampInfo(
        ctx: 'ScreenSwitch',
        message: 'Switching screen without animation within 1ms');
    Navigator.push(
        context,
        PageRouteBuilder(
  ...
  static void changeScreenNoAnimationReplace(
  ...
  static void changeScreenEaseOutBack(Object object, BuildContext context) {
    ampInfo(
        ctx: 'ScreenSwitch',
        message: 'Switching screen with EaseOutBack animation within 200ms');
    Navigator.push(
        context,
        PageRouteBuilder(
  ...
  static void changeScreenEaseOutBackReplace(
      Object object, BuildContext context) {
    ampInfo(
        ctx: 'ScreenSwitch',
        message: 'Switching screen with EaseOutBack animation within 200ms');
